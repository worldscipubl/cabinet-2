    ...
    >
      <div className={classNames(cn.ImgGroup)}>
        {file ? (
          ...
          <IonIcon
            className={classNames(cn.ImgPlaceholder, {
              [cn.error]: !!error,
              [cn.done]: !!file,
            })}
      ...
      <div className={classNames(cn.Footer)}>
        ...
        {titleFile && (
          <div className={classNames(cn.SubmitGroup)}>
            <button
              className={classNames("button button_type_main")}
      ...
      <input
        className={classNames(cn.InputFile)}
